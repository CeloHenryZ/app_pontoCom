...
import 'package:loja_pontocom/app/pdf/pdf_view.dart';
import 'package:loja_pontocom/app/providers/itens_pedido_list.dart';
import 'package:loja_pontocom/app/widgets/cardResumo.dart';
import 'package:loja_pontocom/app/widgets/colors.dart';
import 'package:loja_pontocom/database/database.dart';
                      ...
                      pdfLib.Container(
                          ...
                          child: pdfLib.Column(
                              ...
                              children: [
                                ...
                                pdfLib.Text(
                                  'Número do WhatsApp: (034)99930-5109',
                                  style: pdfLib.TextStyle(
                                        ...
                                        child: Container(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            onTap: () async {
                                              ...
                                              try {
                                                await launch(
                                                    'https://api.whatsapp.com/send?phone=034999305109');
                                              } catch (error) {
                                                print(error);
                                              }
                                            },
