      ...
      children: [
        ...
        SpeedDialChild(
          ...
          onTap: () async {
            //Whats
            try {
              await launch('https://api.whatsapp.com/send?phone=55034999305109');
            } catch (error) {
              print(error);
            }
          },
        ...
        SpeedDialChild(
            ...
            onTap: () async {
              //Face
              try {
                await launch('https://instagram.com/bebidas.commc?igshid=MzRlODBiNWFlZA');
              } catch (error) {
                print(error);
              }
            },
        ...
        /*SpeedDialChild(
            ...
            onTap: () async {
              //Insta
              try {
                await launch('https://instagram.com/pontocomdelivery?igshid=YTY2NzY3YTc=');
              } catch (error) {
                print(error);
              }
            },
